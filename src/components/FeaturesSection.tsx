...
const features: Feature[] = [
    {
      id: 1,
      title: 'تصميم واجهات عصرية',
      description: 'نبتكر تصاميم جذابة تعكس هوية علامتك التجارية وتُعزز ثقة الزوار.',
      icon: (
    ...
    {
      id: 2,
      title: 'تطوير شامل بأحدث التقنيات',
      description: 'نقدّم حلاً متكاملًا يشمل تصميم وتطوير المواقع والتطبيقات بأداء عالٍ واستقرار طويل الأمد.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      id: 3,
      title: 'تجربة مستخدم فعالة',
      description: 'نركز على تقديم تجربة استخدام سلسة، تشجع الزوار على التفاعل وتزيد من معدلات التحويل.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      id: 4,
      title: 'تحسين نتائج البحث (SEO)',
      description: 'نُطبّق استراتيجيات SEO فعالة لتحسين ظهور موقعك في الصفحات الأولى لمحركات البحث.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: 'فريق دعم محترف متاح دائمًا لضمان استقرار موقعك أو تطبيقك على مدار الساعة.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      id: 6,
      title: 'تكامل آمن مع بوابات الدفع',
      description: 'نربط موقعك ببوابات الدفع المحلية والعالمية لتوفير تجربة بيع إلكتروني سهلة وآمنة.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
