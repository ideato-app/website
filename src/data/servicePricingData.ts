        ...
        plans: [
            {
                ...
                features: [
                    'تصميم صفحة رئيسية جذابة + حتى 3 صفحات داخلية',
                    'تصميم متجاوب يعمل بكفاءة على جميع الأجهزة',
                    'نموذج تواصل بسيط يرسل إلى البريد الإلكتروني',
                    'ربط بأيقونات حسابات التواصل الاجتماعي',
                    'شهادة أمان SSL مجانية (https)',
                    'استضافة مجانية لمدة سنة',
                    'لوحة تحكم بسيطة لتعديل النصوص والصور',
            ...
            {
                id: 'web-plus',
                title: 'باقة الموقع المتميز',
                price: '5,000 ج.م',
                priceDetails: 'دفع لمرة واحدة فقط',
                features: [
                    'تصميم مخصص بالكامل يعكس هوية النشاط',
                    'حتى 6 صفحات داخلية + صفحة خدمات تفصيلية',
                    'تصميم سريع ومتجاوب مع جميع الأجهزة',
                    'نموذج تواصل احترافي مع خيارات مخصصة',
                    'ربط مباشر بـ WhatsApp وحسابات التواصل',
                    'لوحة تحكم متقدمة لإدارة الصفحات والمحتوى',
                    'تحسين شامل لسرعة وأداء الموقع',
                    'شهادة SSL مجانية (https)',
                    'استضافة مجانية لمدة سنة',
                    'تحسين SEO على مستوى الصفحات والكلمات المفتاحية',
            ...
            },
            {
                ...
                priceDetails: 'دفع لمرة واحدة فقط',
                features: [
                    'كل مزايا باقة الموقع المتميز',
                    'تصميم متجر احترافي متكامل',
                    'إضافة حتى 100 منتج عند الإطلاق (قابل للتوسعة)',
                    'بوابات دفع إلكتروني (فوري – فيزا – STC Pay)',
                    'نظام متكامل لإدارة الطلبات والعملاء والمخزون',
                    'تصنيفات وفلاتر متقدمة للمنتجات',
                    'كوبونات خصم وعروض ترويجية',
                    'سلة مشتريات ومفضلة للعملاء',
                    'لوحة تحكم شاملة لتقارير ومتابعة الأداء',
                    'تحسين SEO للفئات والمنتجات',
                    'ربط مع منصات التواصل الاجتماعي + Facebook Pixel',
                    'دعم فني لمدة سنة كاملة',
                ],
                isRecommended: false,
                cta: 'انشاء متجرك الآن',
            },
            {
                id: 'web-enterprise',
                title: 'بوابة متكاملة',
                ...
                priceDetails: '',
                features: [
                    'تصميم مخصص بالكامل حسب طبيعة المشروع',
                    'عدد غير محدود من الصفحات والمنتجات والأقسام',
                    'نظام حسابات متعددة (عملاء – بائعين – مدراء)',
                    'تكامل مع أنظمة خارجية (ERP – CRM – APIs)',
                    'تطبيقات موبايل متكاملة (Android و iOS)',
                    'تحليلات وتقارير متقدمة لسلوك المستخدم',
                    'استضافة قوية وأمان عالي المستوى',
                    'دعم فني مخصص على مدار الساعة',
                    'استشارات تسويق رقمي مجانية لثلاثة أشهر',
                    'تحديثات مستمرة وتطوير حسب الطلب',
                    'دعم فني غير محدود حسب الطلب',
                ],
                cta: 'اطلب عرض سعر',
            }
